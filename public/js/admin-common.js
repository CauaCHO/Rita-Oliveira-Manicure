...
export function logout(){sessionStorage.removeItem('agenda_admin_logged'); location.href='login.html';}
export function adminLayout(active, content){
  ...
  const btn = document.getElementById('logoutBtn'); if(btn) btn.onclick = logout;
}
