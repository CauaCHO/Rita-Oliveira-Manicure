...
$('#saveFolga').onclick=()=>{
  ...
  horas.forEach(hora=>{
    if(!Store.hasTimeConflict(data, hora)){
      Store.saveAppointment({data,hora,clienteNome:'',clienteTelefone:'',servicoId:'',servicoNome:'Folga',valor:0,duracaoMinutos:60,statusAgenda:'folga',statusPagamento:'nao_cobrado',observacao,origem:'admin'});
      count++;
    }
  });
